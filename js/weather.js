class Weather {
    ...
    askWeather() {
        ...
        this.getWeatherParisAndDisplay(cityName, currentDate, currentHour, currentCondition, iconWeather, currentTmp);

        this.getWeatherGeolocationAndDisplay(cityName, currentDate, currentHour, currentCondition, iconWeather, currentTmp);
    }

    getWeatherGeolocationAndDisplay(cityName, currentDate, currentHour, currentCondition, iconWeather, currentTmp) {
    ...
    getWeatherParisAndDisplay(cityName, currentDate, currentHour, currentCondition, iconWeather, currentTmp) {
